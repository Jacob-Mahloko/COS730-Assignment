...
{
    public abstract class x10WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static x10WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(x10WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<x10DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<x10DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<x10DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<x10DbContext, Task<T>> func)
        {
            T result;
